Lec09 Unsupervised Learning Mini Proj
================
Michael Nguyen
10/29/2019
...
Note that the `id` and `diagnosis`cols will not be used for most of the
folllowing steps

we have 569 samples in the data set
...
Q1. How many observations are in this dataset? - 569 nrow(wisc.df)
...
dim() - gives ROWS x COLs, nrow() - gives the number of rows, table() -
gives us table by cross-classifying factors, length()- “size” of data
you want to know grep() - pattern matching
...
\==\> Look at *Cumulative Proportion* Q4. From your results, what
proportion of the original variance is captured by the first principal
components (PC1)? - 0.4427
...
![](Lec09_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->

let’s make a plot of PC1 vs. PC2 (with
color)
...
![](Lec09_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

Results = are like whoa. There is a split between cancer and malignant
cancer diagnosis.
...
![](Lec09_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->

Q7. What stands out to you about this plot? Is it easy or difficult to
understand? Why? - It’s messy and difficult to interpret… CRAP

Q8. Generate a similar plot for principal components 1 and 3. What do
you notice about these plots? - It’s somewhat the same as PC1 vs. PC2,
but
lower.
...
![](Lec09_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
cleaner cut separating** the two
subgroups.
...
![](Lec09_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
into a different number of clusters between 2 and 10?
  ...
  - When you change the number clusters (k-value) it shows different
    number of clusters of different specificities. Too little of a
    k-value results in false posisitves while too high of a number
    results in better separation but too many spcifics can be confusing.

# 4\. OPTIONAL: K-means clustering

K-means clustering and comparing results As you now know, there are two
main types of clustering: hierarchical and k-means.
...
compare to your hclust results? - Better as it groups them into
clusters.
...
![](Lec09_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](Lec09_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->

``` r
plot(wisc.pr$x[,1:2], col=diagnosis)
```

![](Lec09_files/figure-gfm/unnamed-chunk-28-2.png)<!-- -->
...
![](Lec09_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
To include the interactive rgl plot in your HTML renderd lab report you
can add the R code `rglwidget(width = 400, height = 400)` after you call
the plot3d() function. It will look just like the plot above. Try
rotating and zooming on this 3D plot.

Q14. How well does the newly created model with four clusters separate
out the two diagnoses? - It separates out them okay
...
containing the actual diagnoses. - We got somoe false positives (healthy
in cancerous cell populations and v.v.)
...
![](Lec09_files/figure-gfm/unnamed-chunk-33-1.png)<!-- --> Q17. Which of
these new patients should we prioritize for follow up based on your
results? - Paitent number 2. RED IS MALIGNANT, BLACK IS BENIGN

# 8\. PCA of protein sturcture data (Optional)

PCA of protein structure data Visit the Bio3D-web PCA app
<http://bio3d.ucsd.edu> and explore how PCA of large protein structure
sets can provide considerable insight into major features and trends
with clear biological mechanistic insight. Note that the final report
generated from this app contains all the R code required to run the
analysis yourself - including PCA and clustering. We will delve more
into this type of analysis in the next class.
